...
void	ft_move_up(t_game *game)
{
	...
	else if (game->map.map[game->p_pos.y - 1][game->p_pos.x] != '1')
	{
		...
		if (game->map.map[game->p_pos.y - 1][game->p_pos.x] == 'C' || game->map.map[game->p_pos.y - 1][game->p_pos.x] == '0' )
		{
...
void	ft_move_right(t_game *game)
{
	...
	else if (game->map.map[game->p_pos.y][game->p_pos.x + 1] != '1')
	{
		game->moves++;
		printf("Moves counter: %d\n", game->moves);
		if (game->map.map[game->p_pos.y][game->p_pos.x + 1] == 'C' || game->map.map[game->p_pos.y][game->p_pos.x + 1] == '0' )
		{
